document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputs = {
        ...
        sizeEdit: document.getElementById('size-slider-edit'),
    ...
    inputs.sizeEdit.addEventListener('input', (e) => {
        inputs.script.style.fontSize = `${e.target.value}px`;
        localStorage.setItem('teleprompter_size_edit', e.target.value);
    });
    ...
    const savedSizeEdit = localStorage.getItem('teleprompter_size_edit') || '18';
    inputs.sizeEdit.value = savedSizeEdit;
    inputs.script.style.fontSize = `${savedSizeEdit}px`;
});
